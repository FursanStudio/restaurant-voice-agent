  ...
  return (
    <section id="about" style={{ padding: "4rem 1.5rem" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr", gap: "3rem" }}
        ...
        {/* Visual */}
        <div style={{ position: "relative", aspectRatio: "4/5", background: "linear-gradient(135deg,#1a1208,#0d0904)", overflow: "hidden", maxHeight: 400 }}>
        ...
        <div>
          ...
          <h2 style={{ fontFamily: "var(--font-playfair)", fontSize: "clamp(1.8rem,5vw,3rem)", fontWeight: 400, color: "#f5ede0", lineHeight: 1.2, marginBottom: "1.5rem" }}>
          ...
          <div style={{ display: "flex", gap: "2rem", marginTop: "2rem", paddingTop: "2rem", borderTop: "1px solid rgba(201,169,110,0.1)", flexWrap: "wrap" }}>
